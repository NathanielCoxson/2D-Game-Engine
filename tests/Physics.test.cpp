...
TEST_CASE("GetOverlap returns the correct overlap for overlapping and scaled entities") {
    Physics phys;
    EntityManager entities;
    auto a = entities.addEntity("a");
    auto b = entities.addEntity("b");
    ...
    a->getComponent<CTransform>().pos = Vec2(10, 10);
    a->getComponent<CTransform>().scale = Vec2(2, 2);
    b->getComponent<CTransform>().pos = Vec2(16, 16);
...
TEST_CASE("GetPreviousOverlap returns the correct overlap for overlapping and scaled entities") {
    Physics phys;
    EntityManager entities;
    auto a = entities.addEntity("a");
    auto b = entities.addEntity("b");
    ...
    a->getComponent<CTransform>().prevPos = Vec2(10, 10);
    a->getComponent<CTransform>().scale = Vec2(2, 2);
    b->getComponent<CTransform>().prevPos = Vec2(16, 16);
